          ...
          children: [
            ...
            context.button(
              data: BaseUiKitButtonData(
                text: 'show suggest place component',
                onPressed: () {
            ...
            context.button(
              data: BaseUiKitButtonData(
                text: 'show settings component',
                onPressed: () => context.push(SettingsComponent(
                  btnDataList: [],
                  controlExpansionTileButtons: [],
                  onSubmitContent: () {},
                )),
              ),
            ),

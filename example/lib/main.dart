      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            context.button(
              data: BaseUiKitButtonData(
                text: 'show add review influencer',
                onPressed: () => context.push(
                  AddInfluencerFeedbackComponent(
                      uiUniversalModel: UiUniversalModel(
                          id: 0,
                          type: 'pro',
                          media: [],
                  ...
                  ComponentBuilder(
                    child: AccountSubscriptionComponent(
                      ...
                      uiModel: UiSubscriptionModel(
                        ...
                        termsOfServiceUrl: 'mock.example.com',
                        privacyPolicyUrl: 'mock.example.com',
                      ),
                    ),
                  ),
                ),

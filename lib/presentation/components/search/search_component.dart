    ...
    final List<Widget> chooseCards = body?[ContentItemType.horizontalList]
            ...
            .map((e) => GestureDetector(
                ...
                child: UiKitTitledCardWithBackground(
                    title: e.key, backgroundImageLink: e.value.imageLink ?? '', backgroundColor: e.value.color ?? Colors.white)))
            .toList() ??
        [];

    return BlurredAppBarPage(
      customToolbarHeight: 150,
      title: title?[ContentItemType.text]?.properties?.keys.firstOrNull ?? 'You’ll find it',
      appBarBody: GestureDetector(
            ...
            child: SingleChildScrollView(
                ...
                child: Column(
                    ...
                    children: [
                      if (model.showFree ?? false) ...[
                        ...
                        UiKitOverflownActionCard(
                            ...
                            title: Stack(children: [
                              RichText(
                                  text: TextSpan(style: theme?.boldTextTheme.body, children: [
                      ...
                      SpacingFoundation.verticalSpace24,
                      Text(body?[ContentItemType.text]?.properties?.keys.firstOrNull ?? 'Choose yourself',
                      ...
                      SingleChildScrollView(
                          ...
                          child: Wrap(
                              ...
                              children: [const SizedBox.shrink(), ...chooseCards, const SizedBox.shrink()])),
                      SpacingFoundation.verticalSpace24,

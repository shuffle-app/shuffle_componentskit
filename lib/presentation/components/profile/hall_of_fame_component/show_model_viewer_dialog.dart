...
showModelViewerDialog(BuildContext context, UiKitAchievementsModel uiKitAchievementsModel, String? cachedPathForModel) {
  if (uiKitAchievementsModel.onLoad != null) {
    uiKitAchievementsModel.onLoad?.call();
  }
  showGeneralDialog(
    ...
    if (uiKitAchievementsModel.unLoad != null) {
      uiKitAchievementsModel.unLoad?.call();
    }
  });
}

...
class PreferencesComponent extends StatelessWidget {
  ...
  PreferencesComponent({Key? key, this.onSubmit, required this.preferences, this.isLoading = false, required this.onSelect})
      : super(key: key);
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
                  width: double.infinity,
                  child: context
                      .button(data: BaseUiKitButtonData(text: 'start to explore'.toUpperCase(), onPressed: onSubmit))

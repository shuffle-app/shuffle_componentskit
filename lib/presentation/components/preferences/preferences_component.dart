...
class PreferencesComponent extends StatelessWidget {
  ...
  PreferencesComponent({Key? key, this.onSubmit, required this.preferences, required this.onSelect}) : super(key: key);
            ...
            child: SingleChildScrollView(
                ...
                child:
                  ...
                  children: preferences.chips.map((chip) {
                    ...
                    return Transform.translate(offset: Offset(rand.nextInt(30) / 2, rand.nextInt(30) / 2), child: chip);
                  }).toList(),
                ))),
        SpacingFoundation.verticalSpace16,
        SizedBox(width: double.infinity, child: context.button(text: 'start to explore'.toUpperCase(), onPressed: onSubmit)),
        SpacingFoundation.verticalSpace16,
      ],
    ));
  }

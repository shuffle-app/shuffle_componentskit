          ...
          if ((feedBusinessModel.showFeelings ?? true)) ...[
            RichText(
              text: TextSpan(
                children: [
                  TextSpan(
                    text: S.of(context).YourNiche,
                    style: themeTitleStyle,
                  ),
                  WidgetSpan(
                    child: feed.showHowItWorksTitle
                        ? HowItWorksWidget(
                    ...
                    child: feed.showHowItWorksTitle
                        ? HowItWorksWidget(
                            ...
                            hintTiles: [
                              ...
                              HintCardUiModel(
                                imageUrl:
                                    GraphicsFoundation.instance.png.dart.path,
                                title: S.current.FeedFeelingsHiwItems(1),
                              ),
                              HintCardUiModel(
                                imageUrl: GraphicsFoundation
                                    .instance.png.sunClouds.path,
                                title: S.current.FeedFeelingsHiwItems(2),
                              ),
                              HintCardUiModel(
                                imageUrl: GraphicsFoundation
                                    .instance.png.smileMood.path,
                  ...
                  child: feed.showHowItWorksBody
                      ? HowItWorksWidget(
                          ...
                          hintTiles: [
                            HintCardUiModel(
                              imageUrl:
                                  GraphicsFoundation.instance.png.events.path,
                              title: S.current.FeedRandomizerHiwItems(0),
                            ),
                            HintCardUiModel(
                              imageUrl: GraphicsFoundation
                                  .instance.png.filtering.path,
                              title: S.current.FeedRandomizerHiwItems(1),
                            ),
                            HintCardUiModel(
                              imageUrl: GraphicsFoundation
                                  .instance.png.chipsSelect.path,
                              title: S.current.FeedRandomizerHiwItems(2),
                            ),
                            HintCardUiModel(
                              imageUrl: GraphicsFoundation
                                  .instance.png.pressScroll.path,
